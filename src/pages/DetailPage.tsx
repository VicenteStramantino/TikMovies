...
function PaginaDetalhes({
  ...
  const streaming = filme.plataformas.length > 0 ? filme.plataformas.join(', ') : 'Nao disponivel para streaming no Brasil'

  const orcamento = filme.orcamento > 0 ? `$ ${filme.orcamento.toLocaleString('en-US')}` : 'Nao informado'
